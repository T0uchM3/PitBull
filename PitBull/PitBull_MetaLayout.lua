...
local function iconPosition_func(unit, frame, id)
	...
	local axisY = data.axisY
	local axisX = data.axisX
	local frame_id = frame[id]
	...
	if attach and point then
		...
		if icon then
			...
			if attach == "frame" then
				if point == "outtopleft" then
					frame_id:SetPoint("BOTTOMLEFT", frame, "TOPLEFT", axisY, axisX)
				elseif point == "outtopright" then
					frame_id:SetPoint("BOTTOMRIGHT", frame, "TOPRIGHT", axisY, axisX)
				elseif point == "outtop" then
					frame_id:SetPoint("BOTTOMLEFT", frame, "TOP", axisY, axisX)
				elseif point == "outbottomleft" then
					frame_id:SetPoint("TOPLEFT", frame, "BOTTOMLEFT", axisY, axisX)
				elseif point == "outbottomright" then
					frame_id:SetPoint("TOPRIGHT", frame, "BOTTOMRIGHT", axisY, axisX)
				elseif point == "outbottom" then
					frame_id:SetPoint("TOPLEFT", frame, "BOTTOM", axisY, axisX)
				elseif point == "outlefttop" then
					frame_id:SetPoint("TOPRIGHT", frame, "TOPLEFT", axisY, axisX)
				elseif point == "outleft" then
					frame_id:SetPoint("RIGHT", frame, "LEFT", axisY, axisX)
				elseif point == "outleftbottom" then
					frame_id:SetPoint("BOTTOMRIGHT", frame, "BOTTOMLEFT",axisY, axisX)
				elseif point == "outrighttop" then
					frame_id:SetPoint("TOPLEFT", frame, "TOPRIGHT", axisY, axisX)
				elseif point == "outright" then
					frame_id:SetPoint("LEFT", frame, "RIGHT", axisY, axisX)
				elseif point == "outrightbottom" then
					frame_id:SetPoint("BOTTOMLEFT", frame, "BOTTOMRIGHT", axisY, axisX)
				elseif point == "center" then
					frame_id:SetPoint("LEFT", frame, "CENTER", axisY, axisX)
				elseif point == "intopleft" then
					frame_id:SetPoint("TOPLEFT", frame, "TOPLEFT",axisY, axisX)
				elseif point == "intop" then
					frame_id:SetPoint("TOPLEFT", frame, "TOP", axisY, axisX)
				elseif point == "intopright" then
					frame_id:SetPoint("TOPRIGHT", frame, "TOPRIGHT", axisY, axisX)
				elseif point == "inbottomleft" then
					frame_id:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", axisY, axisX)
				elseif point == "inbottom" then
					frame_id:SetPoint("BOTTOMLEFT", frame, "BOTTOM", axisY, axisX)
				elseif point == "inbottomright" then
					frame_id:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", axisY, axisX)
				elseif point == "inleft" then
					frame_id:SetPoint("LEFT", frame, "LEFT", axisY, axisX)
				elseif point == "inright" then
					frame_id:SetPoint("RIGHT", frame, "RIGHT", axisY, axisX)
				elseif point == "edgetopleft" then
					frame_id:SetPoint("CENTER", frame, "TOPLEFT", axisY, axisX)
				elseif point == "edgetop" then
					frame_id:SetPoint("LEFT", frame, "TOP", axisY, axisX)
				elseif point == "edgetopright" then
					frame_id:SetPoint("CENTER", frame, "TOPRIGHT", axisY, axisX)
				elseif point == "edgeleft" then
					frame_id:SetPoint("CENTER", frame, "LEFT", axisY, axisX)
				elseif point == "edgeright" then
					frame_id:SetPoint("CENTER", frame, "RIGHT",axisY, axisX)
				elseif point == "edgebottomleft" then
					frame_id:SetPoint("CENTER", frame, "BOTTOMLEFT", axisY, axisX)
				elseif point == "edgebottom" then
					frame_id:SetPoint("LEFT", frame, "BOTTOM", axisY, axisX)
				elseif point == "edgebottomright" then
					frame_id:SetPoint("CENTER", frame, "BOTTOMRIGHT", axisY, axisX)
				end
			elseif frame[attach] then
				if point == "left" then
					frame_id:SetPoint("LEFT", frame[attach], "LEFT", axisY, axisX)
				elseif point == "center" then
					frame_id:SetPoint("LEFT", frame[attach], "CENTER", axisY, axisX)
				elseif point == "right" then
					frame_id:SetPoint("RIGHT", frame[attach], "RIGHT", axisY, axisX)
				elseif point == "top" then
					frame_id:SetPoint("TOPLEFT", frame[attach], "TOP",axisY, axisX)
				elseif point == "bottom" then
					frame_id:SetPoint("BOTTOMLEFT", frame[attach], "BOTTOM", axisY, axisX)
				elseif point == "topleft" then
					frame_id:SetPoint("TOPLEFT", frame[attach], "TOPLEFT", axisY, axisX)
				elseif point == "topright" then
					frame_id:SetPoint("TOPRIGHT", frame[attach], "TOPRIGHT", axisY, axisX)
				elseif point == "bottomleft" then
					frame_id:SetPoint("BOTTOMLEFT", frame[attach], "BOTTOMLEFT", axisY, axisX)
				elseif point == "bottomright" then
					frame_id:SetPoint("BOTTOMRIGHT", frame[attach], "BOTTOMRIGHT",axisY, axisX)
				elseif point == "outright" then
					frame_id:SetPoint("LEFT", frame[attach], "RIGHT", axisY, axisX)
				elseif point == "outleft" then
					frame_id:SetPoint("RIGHT", frame[attach], "LEFT", axisY, axisX)
				end
			end
		end
	end
...
local function iconPosX_get(group, name)
	return MetaLayout_db.profile[group].icons[name].axisX
end
local function iconPosX_set(group, name, value)
	MetaLayout_db.profile[group].icons[name].axisX = value

	for unit, frame in PitBull:IterateUnitFramesByGroup(group) do
		PitBull:UpdateLayout(frame)
	end
end
local function iconPosY_get(group, name)
	return MetaLayout_db.profile[group].icons[name].axisY
end
local function iconPosY_set(group, name, value)
	MetaLayout_db.profile[group].icons[name].axisY = value
